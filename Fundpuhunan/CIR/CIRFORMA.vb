...
Public Class CIRFORMA
    ...
    Private Sub CIR_MON_KeyPress(sender As Object, e As KeyPressEventArgs)
        If Not Char.IsLetter(e.KeyChar) And Not e.KeyChar = Chr(Keys.Delete) And Not e.KeyChar = Chr(Keys.Back) And Not e.KeyChar = Chr(Keys.Space) Then
            e.Handled = True
            MessageBox.Show("This field will accept letters only")
        End If
    ...
    Private Sub CIR_DAY_KeyPress(sender As Object, e As KeyPressEventArgs)
    ...
    Private Sub CIR_AGE_KeyPress(sender As Object, e As KeyPressEventArgs)
        If Not Char.IsNumber(e.KeyChar) And Not e.KeyChar = Chr(Keys.Delete) And Not e.KeyChar = Chr(Keys.Back) And Not e.KeyChar = Chr(Keys.Space) Then
            e.Handled = True
            MessageBox.Show("This field will accept numbers only")
        End If
    ...
    Private Sub CIR_YR_KeyPress(sender As Object, e As KeyPressEventArgs)
        If Not Char.IsNumber(e.KeyChar) And Not e.KeyChar = Chr(Keys.Delete) And Not e.KeyChar = Chr(Keys.Back) And Not e.KeyChar = Chr(Keys.Space) Then
            e.Handled = True
            MessageBox.Show("This field will accept numbers only")
        End If
    ...
    Private Sub COL_ADDBTN_Click(sender As Object, e As EventArgs) Handles COL_ADDBTN.Click
    ...
    Private Sub LIA_UPBTN_Click(sender As Object, e As EventArgs) Handles LIA_UPBTN.Click
    ...
    Private Sub COL_UPBUTTON_Click(sender As Object, e As EventArgs) Handles COL_UPBUTTON.Click
        If ListView2.SelectedItems.Count > 0 Then
    ...
    Private Sub LIA_REMBTN_Click(sender As Object, e As EventArgs) Handles LIA_REMBTN.Click
        If ListView1.SelectedItems.Count > 0 Then
    ...
    Private Sub COL_REMBTN_Click(sender As Object, e As EventArgs) Handles COL_REMBTN.Click
        If ListView2.SelectedItems.Count > 0 Then
    ...
    Private Sub LIA_REMALLBTN_Click(sender As Object, e As EventArgs) Handles LIA_REMALLBTN.Click
        ListView1.Items.Clear()
    End Sub

    Private Sub COL_REMALLBTN_Click(sender As Object, e As EventArgs) Handles COL_REMALLBTN.Click
        ListView2.Items.Clear()
    End Sub

    Private Sub CIR_BACKBTN_Click(sender As Object, e As EventArgs) Handles CIR_BACKBTN.Click
        AppFormB.Show()
        Me.Hide()
    End Sub
