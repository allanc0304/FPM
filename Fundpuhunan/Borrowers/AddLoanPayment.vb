Public Class AddLoanPayment
    ...
    Private Sub AP_WEEK_KeyPress(sender As Object, e As KeyPressEventArgs) Handles AP_WEEK.KeyPress
    ...
    Private Sub AP_INS_KeyPress(sender As Object, e As KeyPressEventArgs) Handles AP_INS.KeyPress
        If Not Char.IsNumber(e.KeyChar) And Not e.KeyChar = Chr(Keys.Delete) And Not e.KeyChar = Chr(Keys.Back) And Not e.KeyChar = Chr(Keys.Space) Then
            e.Handled = True
            MessageBox.Show("This field will accept number only")
        End If
    ...
    Private Sub AP_SAV_KeyPress(sender As Object, e As KeyPressEventArgs) Handles AP_SAV.KeyPress
        If Not Char.IsNumber(e.KeyChar) And Not e.KeyChar = Chr(Keys.Delete) And Not e.KeyChar = Chr(Keys.Back) And Not e.KeyChar = Chr(Keys.Space) Then
            e.Handled = True
            MessageBox.Show("This field will accept number only")
        End If
    ...
    Private Sub AP_CONFIRMBTN_Click(sender As Object, e As EventArgs) Handles AP_CONFIRMBTN.Click
        ...
        If Vld(AP_CB, AP_WEEK, AP_EA, AP_INS, AP_SAV, AP_PEN, AP_COLB) = False Then
